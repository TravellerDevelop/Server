...
export function createPost(req, res, cache) {
...
export function takePosts(req, res, cache) {
...
export function takeLastsPostByUsername(req, res, cache) {
...
export function updatePinPost(req, res) {
